 ...
 */
public class FragmentFotosClasicas extends Fragment {

    RecyclerView recyclerClasicas;
    TextView cargando;
    ProductosBean productosBean;



    public FragmentFotosClasicas() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_fotos_clasicas, container, false);

        recyclerClasicas = (RecyclerView) view.findViewById(R.id.recyclerFotosClasicas);
        ...
        if(ControladorInternet.isNetworkConnected(getActivity().getApplicationContext())){
            ...
            recyclerClasicas.setVisibility(View.INVISIBLE);
    ...
    private void fillData(){
        ...
        recyclerClasicas.setLayoutManager(new LinearLayoutManager(getContext()));

        FirebaseInstancia.reference.child("fotos20x30").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                cargando.setVisibility(View.GONE);
                recyclerClasicas.setVisibility(View.VISIBLE);
                recyclerClasicas.setAdapter(adaptador);
