 ...
 */
public class FragmentLapidas extends Fragment {

    RecyclerView recyclerLapidas;
    TextView cargando;
    ProductosBean productosBean;


    public FragmentLapidas() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_lapidas, container, false);

        recyclerLapidas = (RecyclerView) view.findViewById(R.id.recyclerLapidas);
        ...
        if(ControladorInternet.isNetworkConnected(getActivity().getApplicationContext())){
            ...
            recyclerLapidas.setVisibility(View.INVISIBLE);
    ...
    private void fillData(){
        ...
        recyclerLapidas.setLayoutManager(new LinearLayoutManager(getContext()));


        FirebaseInstancia.reference.child("lapidas").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                cargando.setVisibility(View.GONE);
                recyclerLapidas.setVisibility(View.VISIBLE);
                recyclerLapidas.setAdapter(adaptador);
