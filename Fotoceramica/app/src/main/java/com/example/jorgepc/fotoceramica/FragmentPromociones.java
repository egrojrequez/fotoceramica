...
public class FragmentPromociones extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerPromos = (RecyclerView) view.findViewById(R.id.recyclerPromos);
        ...
        if(ControladorInternet.isNetworkConnected(getActivity().getApplicationContext())){
            ...
            recyclerPromos.setVisibility(View.INVISIBLE);
    ...
    private void fillData(){
        ...
        FirebaseInstancia.reference.child("promociones").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                cargando.setVisibility(View.GONE);
                recyclerPromos.setVisibility(View.VISIBLE);
                recyclerPromos.setAdapter(adaptador);
